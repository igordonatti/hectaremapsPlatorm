...
const ProjectItem:React.FC<{project: ProjectsType}> = ({ project }) => {
  ...
  return ( 
    <div className="text-green-600 h-12 font-poppins bg-gray-100 rounded-r-lg flex items-center p-3 cursor-pointer justify-between hover:bg-gray-300 border-l-4 border-l-green-800">
