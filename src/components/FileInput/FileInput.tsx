...
const Input = ({ dropzone }: InputProps) => {
  ...
  return (
    <div
      {...getRootProps()}
      className={`w-[80%] h-full rounded-lg border-dashed border-4 hover:border-gray-500 bg-white hover:bg-slate-200 transition-all
        ...
        <div className="flex flex-col items-center justify-center pt-5 pb-6 w-full h-full">
          ...
          {isDragActive ? (
            ...
            <>
              ...
              <p className="text-gray-400 text-sm">.ZIP</p>
            </>
          )}
        </div>
      </label>
...
const HasFile = ({ file, removeFile }: HasFileProps) => {
  return (
    <div className="w-[80%] h-full rounded-lg border-dashed border-4 border-gray-600 bg-green-600 flex justify-center items-center">
